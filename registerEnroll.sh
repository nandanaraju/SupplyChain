...
function createbuyer() {
  ...
  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-buyer -M "${PWD}/organizations/peerOrganizations/buyer.example.com/peers/peer0.buyer.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/buyer/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  echo "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-buyer -M "${PWD}/organizations/peerOrganizations/buyer.example.com/users/User1@buyer.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/buyer/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://buyeradmin:buyeradminpw@localhost:11054 --caname ca-buyer -M "${PWD}/organizations/peerOrganizations/buyer.example.com/users/Admin@buyer.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/buyer/ca-cert.pem"
  { set +x; } 2>/dev/null
