...
export manufacturer_PEER_TLSROOTCERT=${PWD}/organizations/peerOrganizations/manufacturer.example.com/peers/peer0.manufacturer.example.com/tls/ca.crt
export dealer_PEER_TLSROOTCERT=${PWD}/organizations/peerOrganizations/dealer.example.com/peers/peer0.dealer.example.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups.manufacturerMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.manufacturer.example.com","port": 7051}]},"version": "0"}}' config_copy.json > modified_config.json
...
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/dealer.example.com/peers/peer0.dealer.example.com/tls/ca.crt
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/dealer.example.com/users/Admin@dealer.example.com/msp
...
jq '.channel_group.groups.Application.groups.dealerMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.dealer.example.com","port": 9051}]},"version": "0"}}' config_copy.json > modified_config.json
...
jq '.channel_group.groups.Application.groups.buyerMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.buyer.example.com","port": 11051}]},"version": "0"}}' config_copy.json > modified_config.json
